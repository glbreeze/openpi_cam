...
class LeRobotRobocasaCamDataConfig(DataConfigFactory):
    ...
    # standard Pi0 path. The delta mask here is single-arm + base + control_mode
    # layout (distinct from the multi-arm LIBERO layout).
...
_CONFIGS = [
    ...
    # factory so local-dataset quirks do not leak into LIBERO.
    TrainConfig(
