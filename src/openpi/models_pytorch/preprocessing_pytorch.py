...
def preprocess_observation_pytorch(
    ...
    *,
    ...
    return SimpleProcessedObservation(
        ...
        point_target_xy=_clone_optional_tensor(getattr(observation, "point_target_xy", None)),
        point_target_logz=_clone_optional_tensor(getattr(observation, "point_target_logz", None)),
        point_target_conf=_clone_optional_tensor(getattr(observation, "point_target_conf", None)),
        point_target_source=_clone_optional_tensor(getattr(observation, "point_target_source", None)),
