...
export CONFIG_NAME="${CONFIG_NAME:-pi0_libero_cam_pytorch_prope_ray_view_distill_fullres_stage2_fgfg_hard}"
export EXP_NAME="${EXP_NAME:-pi0_libero_object_cam_v3_prope_ray_view_distill_fullres_twostage_decouple_fgfg_hard_stage2_2gpu}"
export CHECKPOINT_ROOT="${CHECKPOINT_ROOT:-${REPO_ROOT}/checkpoints/pi0_libero_cam_pytorch_prope_ray_view_distill_fullres_stage2_fgfg_hard/${EXP_NAME}}"
