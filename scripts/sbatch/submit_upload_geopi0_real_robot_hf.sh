...
TARGET_SCRIPT="${REPO_ROOT}/scripts/sbatch/upload_geopi0_real_robot_hf.sbatch"
...
echo "Submitting Hugging Face upload job for GeoPi0-real-robot"
echo "repo root: ${REPO_ROOT}"
echo "target script: ${TARGET_SCRIPT}"
echo "release dir: ${RELEASE_DIR:-/scratch/${USER}/hf_release/GeoPi0-real-robot}"
echo "hf repo id: ${HF_REPO_ID:-ColinSkywalker/GeoPi0-real-robot}"
echo "hf repo type: ${HF_REPO_TYPE:-model}"
echo "revision: ${HF_UPLOAD_REVISION:-<default>}"
echo "num workers: ${HF_UPLOAD_NUM_WORKERS:-8}"
