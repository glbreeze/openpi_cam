...
TARGET_SCRIPT="${REPO_ROOT}/scripts/sbatch/train_pi05_ur5_real_robot_cross_attn_fg_distill_stage2_gt_hard.sbatch"
...
echo "Submitting pi0.5 UR5 real-robot fg + hard Stage 2 GT job"
...
echo "stage1 checkpoint root: ${STAGE1_CHECKPOINT_ROOT:-/scratch/${USER}/tmp/openpi_cam/checkpoints/pi05_ur5_real_robot_pytorch_cross_attn_fg_distill_stage1_hard/pi05_ur5_real_robot_cross_attn_fg_distill_gt_hard_stage1}"
echo "exp name: ${EXP_NAME:-pi05_ur5_real_robot_cross_attn_fg_distill_gt_hard_stage2}"
