...
echo "Submitting UR5 real-robot fg + hard Stage 2 with GT supervision"
...
echo "stage1 checkpoint root: ${STAGE1_CHECKPOINT_ROOT:-/scratch/${USER}/tmp/openpi_cam/checkpoints/pi0_ur5_real_robot_pytorch_cross_attn_fg_distill_stage1_hard/pi0_ur5_real_robot_cross_attn_fg_distill_gt_hard_stage1}"
