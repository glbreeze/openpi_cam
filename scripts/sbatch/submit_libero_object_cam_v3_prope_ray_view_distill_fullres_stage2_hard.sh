...
TARGET_SCRIPT="${REPO_ROOT}/scripts/sbatch/train_pi0_libero_cam_v3_prope_ray_view_distill_fullres_stage2_hard.sbatch"
...
echo "Submitting fg + hard Stage 2"
echo "repo root: ${REPO_ROOT}"
echo "target script: ${TARGET_SCRIPT}"
echo "config: pi0_libero_cam_pytorch_prope_ray_view_distill_fullres_stage2_hard"
echo "exp name: ${EXP_NAME:-pi0_libero_object_cam_v3_prope_ray_view_distill_fullres_twostage_decouple_fg_hard_stage2}"
echo "stage1 checkpoint root: ${STAGE1_CHECKPOINT_ROOT:-${REPO_ROOT}/checkpoints/pi0_libero_cam_pytorch_prope_ray_view_distill_fullres_stage1_pi3xray_hard/pi0_libero_object_cam_v3_prope_ray_view_distill_fullres_twostage_decouple_fg_hard_stage1_l40s}"
