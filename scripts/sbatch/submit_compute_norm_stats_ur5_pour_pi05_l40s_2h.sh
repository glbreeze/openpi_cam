...
SBATCH_SCRIPT="${REPO_ROOT}/scripts/sbatch/compute_norm_stats_ur5_pour_pi05_l40s_2h.sbatch"
...
CONFIG_NAME="${CONFIG_NAME:-pi05_ur5_real_robot_pytorch_cross_attn_fg_distill_stage1_hard}"

mkdir -p "${REPO_ROOT}/log/compute_norm_stats_ur5_pour"

echo "Submitting UR5 pour pi0.5 norm stats job"
echo "repo root: ${REPO_ROOT}"
echo "geo root: ${GEO_ROOT}"
echo "config: ${CONFIG_NAME}"
echo "dataset repo id: ${DATASET_REPO_ID}"
echo "norm asset id: ${NORM_ASSET_ID}"
echo "output dir: ${GEO_ROOT}/pi05_ur5_real_robot/${NORM_ASSET_ID}"
