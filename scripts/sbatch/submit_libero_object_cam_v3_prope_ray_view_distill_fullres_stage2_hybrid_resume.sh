...
TARGET_SCRIPT="${REPO_ROOT}/scripts/sbatch/train_pi0_libero_cam_v3_prope_ray_view_distill_fullres_stage2_hybrid_resume.sbatch"
...
echo "Submitting fg + hybrid Stage 2 resume"
echo "repo root: ${REPO_ROOT}"
echo "target script: ${TARGET_SCRIPT}"
echo "config: pi0_libero_cam_pytorch_prope_ray_view_distill_fullres_stage2_hybrid"
echo "exp name: ${EXP_NAME:-pi0_libero_object_cam_v3_prope_ray_view_distill_fullres_twostage_decouple_fg_hybrid_stage2}"
