...
TARGET_SCRIPT="${REPO_ROOT}/scripts/sbatch/train_pi0_robocasa24_all24_baseline_l40s.sbatch"

SBATCH_ACCOUNT=${SBATCH_ACCOUNT:-torch_pr_926_general}
SBATCH_PARTITION=${SBATCH_PARTITION:-l40s_public}
SBATCH_GRES=${SBATCH_GRES:-gpu:l40s:4}
...
echo "Submitting RoboCasa24 Pi0 baseline training"
...
echo "exp name: ${EXP_NAME:-pi0_robocasa24_all24_baseline_v1}"
