...
TARGET_SCRIPT="${REPO_ROOT}/scripts/sbatch/train_pi0_libero_cam_v2_prope_ray_view_distill_fullres_hard.sbatch"
...
echo "Submitting fg + hard-loss full-suite training"
...
echo "config: pi0_libero_cam_v2_pytorch_prope_ray_view_distill_fullres_hard"
echo "exp name: ${EXP_NAME:-pi0_libero_cam_v2_prope_ray_view_distill_fullres_hard_v1}"
