...
TARGET_SCRIPT="${REPO_ROOT}/scripts/sbatch/train_pi05_ur5_real_robot_cross_attn_fg_distill_gt_stage1_stage2_hard.sbatch"
...
echo "Submitting pi0.5 UR5 real-robot fg + hard GT combined Stage 1 + Stage 2"
...
echo "stage1 exp: ${STAGE1_EXP_NAME:-pi05_ur5_real_robot_cross_attn_fg_distill_gt_hard_stage1_4gpu_grid224}"
...
echo "stage2 exp: ${STAGE2_EXP_NAME:-pi05_ur5_real_robot_cross_attn_fg_distill_gt_hard_stage2_4gpu_grid224}"
...
echo "default cpus: ${SBATCH_CPUS:-32}"
