...
TARGET_SCRIPT="${REPO_ROOT}/scripts/sbatch/compute_pi05_ur5_real_robot_norm_stats_l40s_1h.sbatch"
...
echo "Submitting pi05 UR5 real-robot norm-stats job on L40S"
echo "repo root: ${REPO_ROOT}"
echo "target script: ${TARGET_SCRIPT}"
echo "config: ${CONFIG_NAME:-pi05_ur5_real_robot_pytorch_baseline}"
...
echo "pi3x targets 224 base dir: ${OPENPI_PI3X_TARGETS_224_BASE_DIR:-/scratch/${USER}/openpi_cache/pi3x_targets_224}"
...
echo "default cpus-per-task: ${SBATCH_CPUS:-16}"
echo "default mem: ${SBATCH_MEM:-64G}"
echo "default time: ${SBATCH_TIME:-01:00:00}"
