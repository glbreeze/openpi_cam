...
TARGET_SCRIPT="${REPO_ROOT}/scripts/sbatch/train_pi0_robocasa24_all24_pytorch_baseline.sbatch"
if [[ "${RESUME:-false}" == "true" ]]; then
  TARGET_SCRIPT="${REPO_ROOT}/scripts/sbatch/train_pi0_robocasa24_all24_pytorch_baseline_resume.sbatch"
fi
...
echo "Submitting RoboCasa Pi0 baseline training"
...
echo "exp name: ${EXP_NAME:-pi0_robocasa24_all24_pytorch_baseline_v1}"
