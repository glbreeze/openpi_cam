...
TARGET_SCRIPT="${REPO_ROOT}/scripts/sbatch/train_pi0_ur5_real_robot_cross_attn_fg_distill_gt_stage1_stage2_hard_a100_2gpu_2day.sbatch"

SBATCH_ACCOUNT=${SBATCH_ACCOUNT:-torch_pr_69_tandon_advanced}
SBATCH_PARTITION=${SBATCH_PARTITION:-a100_tandon}
...
echo "Submitting Pi0 UR5 real-robot fg + hard GT combined Stage 1 + Stage 2 (A100 2 GPU, 2 day)"
...
echo "stage1 exp: ${STAGE1_EXP_NAME:-pi0_ur5_real_robot_cross_attn_fg_distill_gt_hard_stage1_a100_2gpu_b32}"
...
echo "stage2 exp: ${STAGE2_EXP_NAME:-pi0_ur5_real_robot_cross_attn_fg_distill_gt_hard_stage2_a100_2gpu_b32}"
