...
TARGET_SCRIPT="${REPO_ROOT}/scripts/sbatch/upload_pour_pi05_gt_25k_hf.sbatch"
...
echo "Submitting Hugging Face upload job for pour_pi05_gt 25000"
...
echo "commit message: ${HF_UPLOAD_COMMIT_MESSAGE:-Upload pour_pi05_gt 25000 checkpoint and remove placeholder}"
