...
TARGET_SCRIPT="${REPO_ROOT}/scripts/sbatch/convert_pi05_base_l40s_90m.sbatch"
...
echo "Submitting pi05_base conversion on L40S"
echo "repo root: ${REPO_ROOT}"
echo "target script: ${TARGET_SCRIPT}"
echo "jax checkpoint dir: ${PI05_JAX_CHECKPOINT_DIR:-/scratch/${USER}/.cache/openpi/openpi-assets/checkpoints/pi05_base}"
echo "pytorch output dir: ${PI05_PYTORCH_OUTPUT_DIR:-/scratch/${USER}/pi05_base}"
...
echo "default cpus-per-task: ${SBATCH_CPUS:-8}"
echo "default mem: ${SBATCH_MEM:-128G}"
echo "default time: ${SBATCH_TIME:-01:30:00}"
