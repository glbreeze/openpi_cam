...
TARGET_SCRIPT="${REPO_ROOT}/scripts/sbatch/train_pi0_ur5_real_robot_cross_attn_fg_distill_stage1_gt_hard_l40s.sbatch"
...
echo "Submitting UR5 real-robot fg + hard Stage 1 on L40S with GT supervision"
...
echo "exp name: ${EXP_NAME:-pi0_ur5_real_robot_cross_attn_fg_distill_gt_hard_stage1}"
