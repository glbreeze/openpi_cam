...
TARGET_SCRIPT="${REPO_ROOT}/scripts/sbatch/train_pi05_ur5_real_robot_cross_attn_fg_distill_stage1_gt_hard_l40s.sbatch"
...
echo "Submitting pi0.5 UR5 real-robot fg + hard Stage 1 GT job"
...
echo "exp name: ${EXP_NAME:-pi05_ur5_real_robot_cross_attn_fg_distill_gt_hard_stage1}"
...
echo "default num train steps: ${NUM_TRAIN_STEPS:-5000}"
