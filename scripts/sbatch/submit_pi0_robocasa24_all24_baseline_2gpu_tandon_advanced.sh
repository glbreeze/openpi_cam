...
TARGET_SCRIPT="${REPO_ROOT}/scripts/sbatch/train_pi0_robocasa24_all24_baseline_2gpu_tandon_advanced.sbatch"
...
echo "Submitting RoboCasa24 Pi0 baseline training (Tandon Advanced 2 GPU)"
