...
echo "Submitting pi0.5 UR5 real-robot fg + hard combined Stage 1 + Stage 2 (A100 2 GPU, 2 day)"
...
echo "stage1 exp: ${STAGE1_EXP_NAME:-pi05_ur5_real_robot_cross_attn_fg_distill_hard_stage1_a100_2gpu_b32}"
...
echo "stage2 exp: ${STAGE2_EXP_NAME:-pi05_ur5_real_robot_cross_attn_fg_distill_hard_stage2_a100_2gpu_b32}"
