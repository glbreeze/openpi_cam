...
TARGET_SCRIPT="${REPO_ROOT}/scripts/sbatch/train_pi0_libero_cam_v2_pytorch_baseline_smoke.sbatch"
...
echo "exp name: ${EXP_NAME:-pi0_libero_cam_v2_pytorch_baseline_smoke}"
