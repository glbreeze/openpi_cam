...
TARGET_SCRIPT="${REPO_ROOT}/scripts/sbatch/train_pi0_robocasa24_all24_baseline_smoke_l40s.sbatch"
...
echo "Submitting RoboCasa24 Pi0 baseline smoke test"
...
echo "exp name: ${EXP_NAME:-pi0_robocasa24_all24_baseline_smoke}"
...
echo "default batch size: ${BATCH_SIZE:-4}"
echo "default num workers: ${NUM_WORKERS:-2}"
echo "default num train steps: ${NUM_TRAIN_STEPS:-100}"
