...
TARGET_SCRIPT="${REPO_ROOT}/scripts/sbatch/train_pi0_ur5_real_robot_cross_attn_fg_distill_stage2_hard_2gpu.sbatch"
...
echo "Submitting UR5 real-robot fg + hard Stage 2 (2 GPU)"
...
echo "exp name: ${EXP_NAME:-pi0_ur5_real_robot_cross_attn_fg_distill_hard_stage2_2gpu}"
