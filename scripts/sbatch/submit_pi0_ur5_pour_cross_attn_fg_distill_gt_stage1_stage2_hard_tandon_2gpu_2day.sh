...
echo "stage1 exp: ${STAGE1_EXP_NAME:-pi0_ur5_pour_cross_attn_fg_zeroinit_gt_hard_stage1_tandon_2gpu_b16}"
...
echo "stage2 exp: ${STAGE2_EXP_NAME:-pi0_ur5_pour_cross_attn_fg_zeroinit_gt_hard_stage2_tandon_2gpu_b16}"
