...
TARGET_SCRIPT="${REPO_ROOT}/scripts/sbatch/train_pi0_robocasa24_all24_baseline_4gpu_tandon_advanced.sbatch"
...
echo "Submitting RoboCasa24 Pi0 baseline training (Tandon Advanced 4 GPU)"
...
echo "exp name: ${EXP_NAME:-pi0_robocasa24_all24_baseline_tandon_4gpu_v1}"
