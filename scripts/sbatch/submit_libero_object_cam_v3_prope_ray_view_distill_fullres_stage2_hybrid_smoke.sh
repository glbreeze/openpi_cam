...
TARGET_SCRIPT="${REPO_ROOT}/scripts/sbatch/train_pi0_libero_cam_v3_prope_ray_view_distill_fullres_stage2_hybrid_smoke.sbatch"
...
echo "Submitting fg + hybrid Stage 2 smoke test"
echo "repo root: ${REPO_ROOT}"
echo "target script: ${TARGET_SCRIPT}"
echo "config: pi0_libero_cam_pytorch_prope_ray_view_distill_fullres_stage2_hybrid"
echo "exp name: ${EXP_NAME:-pi0_libero_object_cam_v3_prope_ray_view_distill_fullres_twostage_decouple_fg_hybrid_stage2_smoke}"
echo "stage1 checkpoint root: ${STAGE1_CHECKPOINT_ROOT:-${REPO_ROOT}/checkpoints/pi0_libero_cam_pytorch_prope_ray_view_distill_fullres_stage1_pi3xray_hybrid/pi0_libero_object_cam_v3_prope_ray_view_distill_fullres_twostage_decouple_fg_hybrid_stage1_l40s}"
