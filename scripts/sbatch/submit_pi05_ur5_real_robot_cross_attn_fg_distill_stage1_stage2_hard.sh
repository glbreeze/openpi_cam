...
TARGET_SCRIPT="${REPO_ROOT}/scripts/sbatch/train_pi05_ur5_real_robot_cross_attn_fg_distill_stage1_stage2_hard.sbatch"
...
echo "Submitting pi0.5 UR5 real-robot fg + hard combined Stage 1 + Stage 2"
...
echo "stage1 exp: ${STAGE1_EXP_NAME:-pi05_ur5_real_robot_cross_attn_fg_distill_hard_stage1_4gpu_targetfix}"
...
echo "stage2 exp: ${STAGE2_EXP_NAME:-pi05_ur5_real_robot_cross_attn_fg_distill_hard_stage2_4gpu_targetfix}"
