...
TARGET_SCRIPT="${REPO_ROOT}/scripts/sbatch/train_pi05_ur5_real_robot_pytorch_baseline_tandon_2gpu_24h.sbatch"
...
echo "Submitting Pi0.5 UR5 tube baseline training"
...
echo "exp name: ${EXP_NAME:-pi05_ur5_real_robot_pytorch_baseline_tandon_2gpu_b16}"
