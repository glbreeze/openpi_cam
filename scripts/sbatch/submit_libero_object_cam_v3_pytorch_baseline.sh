...
if [[ "${RESUME}" == "true" ]]; then
  TARGET_SCRIPT="${REPO_ROOT}/scripts/sbatch/train_pi0_libero_object_cam_v3_pytorch_baseline_resume.sbatch"
else
  TARGET_SCRIPT="${REPO_ROOT}/scripts/sbatch/train_pi0_libero_object_cam_v3_pytorch_baseline.sbatch"
fi
...
echo "Submitting PyTorch baseline training"
...
echo "exp name: ${EXP_NAME:-pi0_libero_object_cam_v3_pytorch_baseline_v1}"
