...
TARGET_SCRIPT="${REPO_ROOT}/scripts/sbatch/train_pi05_ur5_real_robot_cross_attn_fg_distill_stage1_gt_hard_smoke_l40s.sbatch"
...
echo "Submitting pi0.5 UR5 real-robot fg + hard Stage 1 GT smoke test on L40S"
echo "repo root: ${REPO_ROOT}"
echo "target script: ${TARGET_SCRIPT}"
echo "config: ${CONFIG_NAME:-pi05_ur5_real_robot_pytorch_cross_attn_fg_distill_stage1_hard}"
...
echo "exp name: ${EXP_NAME:-pi05_ur5_real_robot_cross_attn_fg_distill_gt_hard_stage1_smoke}"
