...
TARGET_SCRIPT="${REPO_ROOT}/scripts/sbatch/train_pi05_ur5_real_robot_cross_attn_fg_distill_stage1_stage2_hard_smoke.sbatch"
...
echo "Submitting pi0.5 UR5 real-robot fg + hard Stage 1 + Stage 2 smoke"
...
echo "stage1 exp: ${STAGE1_EXP_NAME:-pi05_ur5_real_robot_cross_attn_fg_distill_hard_stage1_targetfix_smoke}"
echo "stage2 exp: ${STAGE2_EXP_NAME:-pi05_ur5_real_robot_cross_attn_fg_distill_hard_stage2_targetfix_smoke}"
