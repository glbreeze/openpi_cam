...
TARGET_SCRIPT="${REPO_ROOT}/scripts/sbatch/cache_real_robot_gt_targets_224_l40s.sbatch"
...
echo "Submitting UR5 GT target cache job on L40S"
echo "repo root: ${REPO_ROOT}"
echo "target script: ${TARGET_SCRIPT}"
echo "dataset dir: ${DATASET_DIR:-/scratch/${USER}/real_robot_data/ur5_lab_test_tube_camera_shifts}"
echo "gt output root: ${GT_OUTPUT_ROOT:-/scratch/${USER}/openpi_cache/pi3x_targets_224/ur5_lab_test_tube_camera_shifts}"
echo "export OPENPI_PI3X_TARGETS_224_BASE_DIR=${OPENPI_PI3X_TARGETS_224_BASE_DIR:-/scratch/${USER}/openpi_cache/pi3x_targets_224}"
...
echo "default batch size: ${BATCH_SIZE:-64}"
echo "auto resume: ${AUTO_RESUME:-1}"
