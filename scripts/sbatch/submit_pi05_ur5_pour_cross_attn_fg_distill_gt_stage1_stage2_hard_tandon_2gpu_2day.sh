...
TARGET_SCRIPT="${REPO_ROOT}/scripts/sbatch/train_pi05_ur5_pour_cross_attn_fg_distill_gt_stage1_stage2_hard_tandon_2gpu_2day.sbatch"
DEFAULT_DATASET_DIR="/scratch/${USER}/real_robot_data/ur5_place_and_pour_nuts_camera_shifts"
DEFAULT_NORM_ROOT="/scratch/${USER}/pi05_ur5_real_robot"
...
echo "Submitting Pi0.5 UR5 pour fg + hard GT zero-init combined Stage 1 + Stage 2 (Tandon 2 GPU)"
...
echo "stage1 config: ${STAGE1_CONFIG_NAME:-pi05_ur5_pour_pytorch_cross_attn_fg_distill_gt_stage1_hard}"
echo "stage1 exp: ${STAGE1_EXP_NAME:-pi05_ur5_pour_cross_attn_fg_zeroinit_gt_hard_stage1_tandon_2gpu_b32}"
echo "stage1 steps: ${STAGE1_NUM_TRAIN_STEPS:-5000}"
echo "stage2 config: ${STAGE2_CONFIG_NAME:-pi05_ur5_pour_pytorch_cross_attn_fg_distill_gt_stage2_hard}"
echo "stage2 exp: ${STAGE2_EXP_NAME:-pi05_ur5_pour_cross_attn_fg_zeroinit_gt_hard_stage2_tandon_2gpu_b32}"
...
echo "default workers total: ${NUM_WORKERS:-8}"
echo "default workers per GPU: 4"
