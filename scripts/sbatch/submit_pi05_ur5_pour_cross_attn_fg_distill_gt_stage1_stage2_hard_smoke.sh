...
TARGET_SCRIPT="${REPO_ROOT}/scripts/sbatch/train_pi05_ur5_pour_cross_attn_fg_distill_gt_stage1_stage2_hard_smoke.sbatch"
...
echo "Submitting Pi0.5 UR5 pour fg + hard GT zero-init Stage 1 + Stage 2 smoke"
...
echo "stage1 exp: ${STAGE1_EXP_NAME:-pi05_ur5_pour_cross_attn_fg_zeroinit_gt_hard_stage1_smoke}"
echo "stage2 config: ${STAGE2_CONFIG_NAME:-pi05_ur5_pour_pytorch_cross_attn_fg_distill_gt_stage2_hard}"
echo "stage2 exp: ${STAGE2_EXP_NAME:-pi05_ur5_pour_cross_attn_fg_zeroinit_gt_hard_stage2_smoke}"
