...
def _obs_to_policy_input(
    ...
    *,
    ...
    for policy_key, obs_key in CAM_KEYS.items():
        if policy_key == "agentview_right" and not include_right_camera:
            continue
...
def main() -> None:
    ...
    parser.add_argument("--include-right-camera", action=argparse.BooleanOptionalAction, default=True)
